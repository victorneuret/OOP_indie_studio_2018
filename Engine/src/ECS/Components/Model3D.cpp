...
Engine::ECS::Component::Model3D::Model3D(const System::Renderer &renderer, const Math::Vec3f &pos, const decltype(_model) &model)
        : AComponent("Model3D"), _node{renderer.create3DModel(model)}, _model{std::string{model}}
{
